...
| check:user-copy-safety | 通过 | 0.4s | 用户端文案不暴露内部技术词或旧阶段痕迹 |
...
| verify:live | 通过 | 35.0s | 线上入口/API 边界/截图巡检 |
| verify:journey | 通过 | 38.2s | 移动端用户主流程旅程 |
